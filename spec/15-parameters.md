...
| P-SCHEMA-REFRESH | schema-manifest refresh period (IB-44); polled while the assignment in force resolves by type, paused under `split`, refreshed at once on return to `legacy` (ADR-23, revised) | 3 600 s | same |
