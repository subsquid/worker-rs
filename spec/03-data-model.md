...
| schema-refresh | schema manifest (legacy) or schema bundle (split) | polled every P-SCHEMA-REFRESH / carried by the network state | updates dynamic-engine registry |
